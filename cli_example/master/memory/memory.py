...
from agent_template.cli_example.master.memory.config import MAX_WORKING_MESSAGES, COMPACT_KEEP_MESSAGES
from agent_template.cli_example.master.memory.prompts import COMPACTION_PROMPT
